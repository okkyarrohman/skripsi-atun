...
<div class="px-4 rounded-lg">
    ...
    <div class="w-full p-7 bg-white rounded-xl flex-col items-start gap-9 inline-flex">
        ...
        <form action="{{ route('user-admin.store', 'siswa') }}" method="POST" enctype="multipart/form-data" class="w-full items-start">
            @csrf
            <div class="mb-5">
            ...
            <div class="mb-5">
                ...
                <input type="text" id="no_absen" name="no_absen" value="{{ old('no_absen') }}"
