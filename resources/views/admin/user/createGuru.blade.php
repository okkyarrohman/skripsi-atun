...
<div class="px-4 rounded-lg">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#" class="ms-1 text-lg font-medium text-custom-orange md:ms-2">Tambah Data Guru</a>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="w-full p-7 bg-white rounded-xl flex-col items-start gap-9 inline-flex">
        ...
        <form action="{{ route('user-admin.store', 'guru') }}" method="POST" enctype="multipart/form-data" class="w-full items-start">
            @csrf
            <div class="mb-5">
            ...
            <div class="mb-5">
                ...
                <label for="file-input"
                    ...
                    <div class="px-4 py-2.5 bg-gray-100">
                        ...
                        <input id="file-input" name="foto" type="file" class="hidden" value="{{ old('foto') }}" />
                    </div>
