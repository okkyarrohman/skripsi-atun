...
<div class="px-4 rounded-lg">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#" class="ms-1 text-lg font-medium text-custom-orange md:ms-2">Edit Data Siswa</a>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="w-full p-7 bg-white rounded-xl flex-col items-start gap-9 inline-flex">
        ...
        <form action="{{ route('user-admin.update', $users->id) }}" method="POST" enctype="multipart/form-data" class="w-full items-start">
            @csrf
            @method('PATCH')
            <div class="mb-5">
