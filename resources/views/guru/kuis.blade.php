...
<style>
    ...
    <div class="bg-white p-7 m-10 flex-col justify-center items-start gap-9 inline-flex">
        ...
        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t ms-auto dark:border-gray-600">
            <button type="button" class="text-white bg-[#FF9119] hover:bg-[#FF9119]/80 focus:ring-4 focus:outline-none focus:ring-[#FF9119]/50 font-medium rounded-lg text-sm text-center inline-flex items-center dark:hover:bg-[#FF9119]/80 dark:focus:ring-[#FF9119]/40 ms-auto px-8 py-4 h-14 gap-3">
        ...
        <div class="py-11 flex-col justify-center items-center gap-2.5 inline-flex">
