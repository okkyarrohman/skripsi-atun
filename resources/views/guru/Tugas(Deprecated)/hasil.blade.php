...
@section('content')
<div class="p-6 bg-neutral-50 rounded-md flex flex-col justify-start items-start gap-9">
    ...
    <div class="flex flex-col justify-center items-end gap-2.5">
        <div class="px-8 py-4 bg-orange-500 rounded-xl justify-center items-center gap-3 inline-flex">
