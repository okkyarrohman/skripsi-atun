    ...
    <div class="p-6 bg-neutral-50 rounded-md flex flex-col justify-start items-start gap-6">
        ...
        <form action="{{ route('tugas-guru.store') }}" method="POST" class="w-full flex flex-col gap-6">
            ...
            <div class="flex flex-col justify-start items-start gap-2">
                ...
                <input type="text" id="nilai" name="nilai" value="{{ $tugasAnswers->tugas_grades ? $tugasAnswers->tugas_grades?->nilai : old('nilai') }}"
                    {{ $tugasAnswers->tugas_grades ? "disabled" : "" }}
            ...
            <div class="flex flex-col justify-start items-start gap-2">
                ...
                <textarea type="text" id="feedback" name="feedback" value="{{ $tugasAnswers->tugas_grades ? $tugasAnswers->tugas_grades?->feedback : old('feedback') }}"
                    {{-- disabled="{{ !$tugasAnswers->tugas_grades }}" --}}
                    {{ $tugasAnswers->tugas_grades ? "disabled" : "" }}
